...
<form action="" style="margin-top=20px; margin-top:40px ;padding:10px 70px;border-style: solid;border-color: lightgray;border-width: 2px;padding: 5px;width: 70%;margin-left: 15%;">
        ...
        <h6>Changer directeur de these : </h6>
        <div class="input-group input-group-sm mb-3" ">
        <span  style="margin-right:20px;">Nom et Prénom de directeur de these actuel : </span>
        ...
        <textarea class="form-control" aria-label="With textarea" placeholder="Motif détaillé du changement de Directeur de thèse"></textarea>
        </div>
