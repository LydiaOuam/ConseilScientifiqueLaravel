...
<head>
    <meta charset='utf-8'>
    <title>@yield('titre','Espace directeur thèse')</title> <!--pour que le titre sera adapte a chaque page-->
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown" style="margin-left:30px;">
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link" href=" {{route('dossier')}}">
            <span><i class="fa fa-folder" aria-hidden="true"></i></span>
            <span>Gérer dossier soutenance</span>
            </a>
          </li>
